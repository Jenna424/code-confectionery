...
const Navbar = () => (
  <div className="ui top menu">
    ...
    <NavLink to="/pastry-planning-pointers" className="item" activeStyle={{fontWeight: 'bold', color: 'violet', backgroundColor: 'lightyellow'}}>Pastry Planning Pointers</NavLink>
